CREATE PROCEDURE [batchSchema__srcObject_stageNextBatch_Step1_StartBatch_usp].[test Extraction Stops at Specified Maximum]
AS
BEGIN
	--ASSEMBLE
	...
	DECLARE @SpecifyMax BINARY(8) = @@DBTS;
	...
	EXECUTE [TestHelpers].[DataBuilder_batchSchema_srcObject_batches] @BatchId = 1, @BatchStart = '2000-01-01', @MaximumValue_IncrementalColumnName = @SpecifyMax;
