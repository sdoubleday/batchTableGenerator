CREATE PROCEDURE [batchSchema__srcObject_stageNextBatch_Step1_StartBatch_usp].[test First Extraction Catches Everything in Source]
AS
BEGIN
	--ASSEMBLE
	...
	EXECUTE [TestHelpers].[DataBuilder_batchSchema_srcObject_batches] @BatchId = 1, @BatchStart = '2000-01-01';
